...
/**
	...
	1. Создаем карту квантовых ячеек, и заполняем ее в соотвствии с правилами соседних ячееек, рандомно по порядку.
	2. Создаем карту квантовых ячеек из уже существующей карты, и заполняем ее по порядку.
	3. Создаем карту квантовых ячеек из уже существующей карты, сканируем ее на уровень этропии создовая список тайлов первого уровня этропии, и заполняем ее по порядку тайлов первого уровня этропии.
